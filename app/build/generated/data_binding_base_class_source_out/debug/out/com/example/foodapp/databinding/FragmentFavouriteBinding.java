...
public final class FragmentFavouriteBinding implements ViewBinding {
  ...
  private FragmentFavouriteBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textHome) {
  ...
  public static FragmentFavouriteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFavouriteBinding((ConstraintLayout) rootView, textHome);
    }
