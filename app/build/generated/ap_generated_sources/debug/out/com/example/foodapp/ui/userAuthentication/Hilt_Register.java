 ...
 */
abstract class Hilt_Register extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_Register(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Register_GeneratedInjector) this.generatedComponent()).injectRegister(UnsafeCasts.<Register>unsafeCast(this));
    }
  }
