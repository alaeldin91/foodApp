 ...
 */
abstract class Hilt_ForgetPasswordFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ForgetPasswordFragment() {
    super();
  }

  Hilt_ForgetPasswordFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ForgetPasswordFragment_GeneratedInjector) this.generatedComponent()).injectForgetPasswordFragment(UnsafeCasts.<ForgetPasswordFragment>unsafeCast(this));
    }
  }
