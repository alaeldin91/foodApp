 ...
 */
abstract class Hilt_VerficationForgetPasswordFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VerficationForgetPasswordFragment() {
    super();
  }

  Hilt_VerficationForgetPasswordFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VerficationForgetPasswordFragment_GeneratedInjector) this.generatedComponent()).injectVerficationForgetPasswordFragment(UnsafeCasts.<VerficationForgetPasswordFragment>unsafeCast(this));
    }
  }
