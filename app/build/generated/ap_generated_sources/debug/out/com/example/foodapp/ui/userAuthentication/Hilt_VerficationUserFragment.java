 ...
 */
abstract class Hilt_VerficationUserFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VerficationUserFragment() {
    super();
  }

  Hilt_VerficationUserFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VerficationUserFragment_GeneratedInjector) this.generatedComponent()).injectVerficationUserFragment(UnsafeCasts.<VerficationUserFragment>unsafeCast(this));
    }
  }
