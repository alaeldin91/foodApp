...
public final class FragmentHome2Binding implements ViewBinding {
  ...
  private FragmentHome2Binding(@NonNull ConstraintLayout rootView, @NonNull TextView textHome) {
  ...
  public static FragmentHome2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHome2Binding((ConstraintLayout) rootView, textHome);
    }
